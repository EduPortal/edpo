                     ...
                     <article class="hentry post">
                        <div class="post__author author vcard inline-items">
                           ...
                           <div class="author-date">
                              <a class="h6 post__author-name fn" href="/profile/{{$post->learning_class->user->id}}">{{$post->learning_class->user->first_name}} {{$post->learning_class->user->last_name}}</a> created a <a class="h6 post__author-name fn" href="/teacher/classes/{{$class->code}}/{{$post->id}}">{{$post->type}}</a>
