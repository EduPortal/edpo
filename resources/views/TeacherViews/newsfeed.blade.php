...
<head>
	...
	<!-- Main Font -->
	<script src="/edpojs/webfontloader.min.js"></script>
	<script>
		WebFont.load({
			google: {
	...
	<link rel="stylesheet" type="text/css" href="/edpo/css/simplecalendar.css">
		...
		<div class="control-block">
			...
			<div class="author-page author vcard inline-items more">
				...
				<a href="02-ProfilePage.html" class="author-name fn">
					...
					<span class="author-subtitle">{{ Auth::user()->values    }}</span>
				</a>
			</div>
...
<script src="/edpo/js/ajax-pagination.js"></script>
...
<script src="/edpo/js/simplecalendar.js"></script>

<!-- Lightbox plugin script-->
<script src="/edpo/js/jquery.magnific-popup.min.js"></script>
