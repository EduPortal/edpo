        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="form-group date-time-picker">
              ...
              <input name="datetimepicker" id="birthday" value="{{$teacher_information['birthday']}}" />
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" value="{{$teacher_information['website']}}" id="website">
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" size="auto" id="province">
                @foreach(getProvices() as $province)
                  @if($province['code'] == $teacher_information['province'])
            ...
            <div class="form-group">
              ...
              <select class="form-control" size="auto" id="city">
                @foreach(getCities() as $city)
                  @if($city['city'] == $teacher_information['city'])
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
              ...
              <textarea class="form-control" id="description">{{$teacher_information['description']}}</textarea>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group is-empty">
              <label class="control-label">Your Birthplace</label>
              <input class="form-control" type="text" id="birthplace" value="{{$teacher_information['birthplace']}}">
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" size="auto" id="marital_status">
                 @foreach(getMartialStatus() as $status)
                  @if($status['code'] == $teacher_information['marital_status'])
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group with-icon">
              ...
              <input id="facebook" class="form-control" type="text" placeholder="https://www.facebook.com/edpo" value="{{$teacher_information['facebook']}}">
              <i style="top: 28px; height: 57px;" class="fa fa-facebook c-facebook" aria-hidden="true"></i>
            </div>
            <div class="form-group with-icon">
              <label class="control-label">Your Twitter Account</label>
              <input id="twitter" class="form-control" type="text" placeholder="https://www.twitter.com/edpo" value="{{$teacher_information['twitter']}}">
            ...
            <div class="form-group with-icon">
              ...
              <input id="linkedin" class="form-control" type="text" placeholder="https://www.linkedin.com/edpo" value="{{$teacher_information['linkedin']}}">
            ...
            <div class="form-group with-icon">
              ...
              <input id="google_plus" class="form-control" type="text" placeholder ="https://plus.google.com/edpo" value="{{$teacher_information['google_plus']}}">
...
<div class="col col-xl-3 order-xl-1 col-lg-3 order-lg-1 col-md-12 order-md-2 col-sm-12  responsive-display-none">
  @include('TeacherViews.components.responsive_sidebar_desktop')
</div>
