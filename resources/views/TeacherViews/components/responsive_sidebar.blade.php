             ...
             <div id="avatar_drop_down_mobile" class="collapse show" role="tabpanel" aria-labelledby="avatar_header_mobile">
                <ul class="your-profile-menu">
                   <li title="Change avatar">
                    ...
                    @else
                      <input type="image" id="image_input_mobile" src="{{$teacher_information['avatar']}}" class="card-img" style=" height: 195px; border-radius: 7em; border: none; padding: 0;" />
                    @endif
                    <form id="avatar_form_mobile" action="/teacher/settings/change-avatar" method="post" enctype="multipart/form-data">
                      @csrf
        ...
        <div id="accordion1" role="tablist" aria-multiselectable="true">
          <div class="card">
            ...
            <div id="collapseOne-1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
              <ul class="your-profile-menu">
               <li>
                  <a href="/teacher/settings/profile">Personal Information</a>
               </li>
               <li>
                  <a href="/teacher/settings/change-password">Change Password</a>
               </li>
               <li>
                  <a href="/teacher/settings/hobbies-and-interests">Hobbies and Interests</a>
               </li>
              </ul>
            </div>
          </div>
