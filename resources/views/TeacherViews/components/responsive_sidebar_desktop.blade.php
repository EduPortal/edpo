             ...
             <div id="avatar_drop_down" class="collapse show" role="tabpanel" aria-labelledby="avatar_header">
                <ul class="your-profile-menu">
                   <li title="Change avatar">
                    ...
                    @else
                      <input type="image" id="image_input" src="{{$teacher_information['avatar']}}" class="card-img" style=" height: 195px; border-radius: 7em; border: none; padding: 0;" />
                    @endif
                    <form id="avatar_form" action="/teacher/settings/change-avatar" method="post" enctype="multipart/form-data">
                      @csrf
